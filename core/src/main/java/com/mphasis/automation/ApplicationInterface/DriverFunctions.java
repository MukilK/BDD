...
public class DriverFunctions {
     ...
     * @param objectInPage : (Optional) Any visible Object in page after the page is
     *                     loaded.
     * @param timeOut      : Max time in seconds to wait for the Object to appear.
     * @return
     * @throws TimeoutException : Exception thrown when the page is not loaded in given time
     *                          frame
     */
     ...
     * Navigates to specified URL.
     *
     * @param objectToWaitFor : Object to wait for loaded.
     * @param timeOut         : Max time in seconds to wait for the Object to appear.
     * @return boolean
     * @throws TimeoutException : Exception thrown when the object is not visible in given
     *                          time frame
     */
     ...
     *
     * @param locator : Any Locator of the web element to be clicked
     */
     ...
     *
     * @param clickableElement : The web element object to be clicked
     */
     ...
     *
     * @param locator : Any Locator of the web element, text for which is to be read
     */
     ...
     *
     * @param element : The web element object whose text is to be read
     */
     ...
     *
     * @param locator       : Locator for which the attribute value is to be fetched
     * @param attributeName : Attribute for which the value is to be fetched
     */
     ...
     *
     * @param element       : Element for which the attribute value is to be fetched
     * @param attributeName : Attribute for which the value is to be fetched
     */
     ...
     *
     * @param locator : Locator of the web element object to be clicked
     * @param text    : Text to be send to given web element
     */
     ...
     *
     * @param locator : Locator of the list box object from which data is to be
     *                selected
     * @param option  : Option to be selected from list
     */
     ...
     *
     * @param locator : Locator of the list box object
     ...
     *
     * @param elementToBeCleared : The web element object, text of which is to be cleared
     */
     ...
     *
     * @param moveToElementLocator : The web element locator, on which mouse hover is to be
     *                             performed
     */
     ...
     *
     * @param moveToElement : The web element object, on which mouse hover is to be
     *                      performed
     */
